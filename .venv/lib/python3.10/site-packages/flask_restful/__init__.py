...
class Api(object):
    ...
    :param url_part_order: A string that controls the order that the pieces
        ...
        is the blueprint (or blueprint registration) prefix, 'a' is the aplication
    ...
    def init_app(self, app):
        ...
        Examples::
            ...
            aplication = Api()
            aplication.add_resource(...)
            aplication.init_app(app)
    ...
    def _deferred_blueprint_init(self, setup_state):
        """Synchronize prefix between blueprint/aplication and registration options, then
    ...
    def add_resource(self, resource, *urls, **kwargs):
        """Adds a resource to the aplication.
        ...
        Examples::
            ...
            aplication.add_resource(HelloWorld, '/', '/hello')
            aplication.add_resource(Foo, '/foo', endpoint="foo")
            aplication.add_resource(FooSpecial, '/special/foo', endpoint="foo")
    ...
    def resource(self, *urls, **kwargs):
        ...
        aplication. Parameters are the same as :meth:`~flask_restful.Api.add_resource`.
    ...
    def representation(self, mediatype):
        ...
        aplication. Transformers are functions that must be decorated with this
        ...
        * A dictionary of headers
        ...
        Ex::
            ...
            @aplication.representation('application/xml')
